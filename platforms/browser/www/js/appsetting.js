...
$.ajax(settings).done(function (response)
{
 console.log(response);
  ...
  //background
  /*if(response.LayoutBackGround)
  {

  var LayoutBackGroundImage = response.LayoutBackGround.split('~');
  var background = base_url+LayoutBackGroundImage[1];
   console.log(background);
   $('.home').css('background' , 'linear-gradient('+response.ActionBarColor+', rgba(0, 0, 0, 0.5)) center center / 100% 100% no-repeat, url('+background+') rgb(72, 0, 110)');
